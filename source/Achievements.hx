...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Hidden achievement
		...
		["Disastre Funkin'!",	"Complete a Song with a rating lower than 20%.",		false],
		["Perfeicao!",				"Complete a Song with a rating of 100%.",				false],
		["Psicopata",			"Watch the Henchmen die over 100 times.",				false],
		["Cordas vocais?",		"Hold down a note for 20 seconds.",						false],
		["Hiperativo",					"Finish a Song without going Idle.",					false],
		["Somente dois de nos.",			"Finish a Song pressing only two keys.",				false],
		["Torradeira Gamer",				"Have you tried to run the game on a toaster?",			false],
